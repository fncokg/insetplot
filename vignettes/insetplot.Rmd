...
```{r quick-start, out.width="100%",fig.asp=0.4,dpi=300}
...
```{r quick-start-custom, out.width="100%",fig.asp=0.4,dpi=300}
...
```{r compare-patchwork-real, fig.cap='Inset via patchwork', out.width="100%",fig.asp=0.4,dpi=300}
...
```{r compare-cowplot-real, fig.cap='Inset via cowplot', out.width="100%",fig.asp=0.4,dpi=300}
...
```{r compare-cowplot-real-asp, fig.cap='Inset via cowplot with wrong aspect ratio', out.width="100%",fig.asp=1.0,dpi=300}
cowplot::ggdraw(main_map) +
    cowplot::draw_plot(inset_map, 0, 0, 0.3, 0.3) # arbitrary width/height
```
...
```{r compare-insetplot-real, fig.cap='Inset via insetplot', out.width="100%",fig.asp=0.4,dpi=300}
config_insetmap(
    data_list = list(nc),
    specs = list(
        inset_spec(main = TRUE),
...
```{r compare-insetplot-real-asp, fig.cap='Inset via insetplot with wrong aspect ratio', out.width="100%",fig.asp=1.0,dpi=300}
with_inset(main_map)
```
